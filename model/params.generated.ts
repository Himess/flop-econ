...
export const META = {
  ...
  "source_note": "IMAGE ASSETS ARE PART OF THE PUBLISHED SURFACE, AND ANNOUNCEMENTS ARE AHEAD OF BOTH. A reconcile that greps page text cannot read a figure rendered inside a PNG. Worse, the figures that matter may not be on the site at all: on 2026-09-10 a tokenomics graphic carrying a different total supply and a 4x validator airdrop was published while flop.finance still served the older asset from origin and its teaser page still read \"Updated 2026-08-26\". Any future reconcile MUST fetch and LOOK AT the graphics, pin their hashes, and treat announcement material as a source that can lead the site. See disagreements.tokenomics_graphic.",
...
export const PARAMS: readonly Param[] = [
  ...
  {
    "key": "channel_attestation_pause_cap_blocks",
    "value": 14400,
    "unit": "blocks",
    "bucket": "DEFINED",
    "cite": "§2.2 (window table); §13 O1",
    "note": "4 h. \"max per-channel pause of attestation-dependent clocks (§13 O1) - scoped pause, never a global halt\". The one thing that can stretch a session's clocks without a dispute, so it belongs on an agent's exposure timeline."
  },
  {
...
export const DISAGREEMENTS: readonly Disagreement[] = [
  {
    ...
    "spec_says": "Appendix A: genesis_supply = 3,500,000,000, split across exactly four buckets by R9.4 - miners 1,200,000,000, VALIDATORS 305,505,000, agents 1,200,000,000, reserve 794,495,000 (D-0438 / D-0435). Year-10 cumulative supply computes to 17,186,624,000 and the perpetual floor is 0.550% of it.",
    "downstream_says": "A FLOP tokenomics graphic published 2026-09-10 states \"18.1bn total supply by year 10\" and \"0.5% terminal inflation / yr\", with an Airdrop of 4.4bn (24.3%) split miners 1.20bn / VALIDATORS 1.20bn / agents 1.20bn / reserve 0.80bn. The validator line is ~4x Appendix A and accounts for the entire difference: 1,200,000,000 - 305,505,000 = 894,495,000, and 17,186,624,000 + 894,495,000 = 18,081,119,000, i.e. 18.1bn. The graphic is internally consistent; it simply uses a genesis figure R9.4 does not.",
