...
export const META = {
  ...
  "spec_status": "Draft",
  "spec_page_updated": "2026-08-27",
  "spec_decision_record": "v0.4 (D-0401..D-0437, D-0501)",
  "fetched": "2026-09-09",
  "fetch_bytes": 427403,
  "fetch_note": "Re-fetched three times on 2026-09-09 (09:01, 17:29, 20:24 local); byte-identical each time. The spec moves on roughly a weekly cadence, so re-diff before trusting this file.",
  "extraction": "spec/yp.txt",
  "appendix_a_rows": {
    "enforced": 112,
    "reference_only": 33,
...
export const PARAMS: readonly Param[] = [
  ...
  },
  {
    ...
    "unit": "FLOP",
    "bucket": "DEFINED",
    "cite": "Appendix A; §2.3; R9.7; D-0421",
    "note": "See disagreements.genesis_supply_fork - the workbook and FLOP's own calculator use 3.5bn."
  },
  {
    ...
    "unit": "FLOP",
    "bucket": "DEFINED",
    "cite": "Appendix A; §2.3; D-0435",
    "note": "Exactly validator_min_stake x 1,000 (the active-set cap). Relation inferred, not stated."
  },
  {
  ...
  {
    "key": "validator_gpu_backend_cost",
    "bucket": "ABSENT",
    "cite": "§15.1; §15.3 (qualitative only); no sizing in the spec",
    "note": "The other heavy leg, and the one most cost models omit. §15.1: \"committee eligibility requires recent verified PoUI work (§15.4), so a production validator co-locates or delegates to a calibrated miner backend.\" §15.3's duty table rates it \"GPU-heavy\" and concludes \"The two heavy legs are DA storage/serving and the committee-keeping GPU work.\" No sizing, hardware spec or cost is given anywhere. User must supply."
  },
  {
    "key": "validator_hardware_spec",
    "bucket": "ABSENT",
    "cite": "no normative source",
    "note": "The spec states NO hardware minimums. §15.3 gives qualitative intensities only (\"light CPU\", \"GB-scale bandwidth\", \"GPU-heavy\"). Any CPU/RAM/NVMe/bandwidth figure circulating is community reporting and MUST NOT be presented as normative."
  },
  {
...
export const DISAGREEMENTS: readonly Disagreement[] = [
  {
    ...
    "spec_says": "genesis_supply = 2,483,460,000 FLOP (Appendix A, §2.3, R9.7, D-0421)",
